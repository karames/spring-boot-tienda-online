        ...
        return args -> {
            ...
            try {
                ...
                if (productoRepository.count() == 0) {
                    System.out.println("Creando productos de prueba...");                    List<Producto> productos = List.of(
                        Producto.builder()
                        ...
                        Producto.builder()
                            ...
                            .precio(BigDecimal.valueOf(599.99))
                            .stock(25)
                            .build(),
                        ...
                        Producto.builder()
                            ...
                            .precio(BigDecimal.valueOf(299.99))
                            .stock(20)
                            .build(),
                        ...
                        Producto.builder()
                            ...
                            .precio(BigDecimal.valueOf(59.99))
                            .stock(35)
                            .build(),
